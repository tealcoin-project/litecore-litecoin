...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"tealcoinaddress\"\n"
            "\nReveals the private key corresponding to 'tealcoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"tealcoinaddress\"   (string, required) The tealcoin address for the private key\n"
            "\nResult:\n"
