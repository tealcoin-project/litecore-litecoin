...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"tealcoinaddress\"\n"
            "\nReturn information about the given tealcoin address.\n"
            "\nArguments:\n"
            "1. \"tealcoinaddress\"     (string, required) The tealcoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"tealcoinaddress\", (string) The tealcoin address validated\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"tealcoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"tealcoinaddress\"  (string, required) The tealcoin address to use for the signature.\n"
